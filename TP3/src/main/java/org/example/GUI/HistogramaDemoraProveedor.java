...
public class HistogramaDemoraProveedor {
        public static void mostrarHistogramaDemoras(int[] mesesDemora, int[] frecuenciaDemora) {
            // 1. Crear el dataset para el histograma
            DefaultCategoryDataset dataset = new DefaultCategoryDataset();

            Map<Integer, Integer> frecuenciaDemora = new HashMap<>();
